    ...
    <body class="font-sans text-gray-900 antialiased dark:bg-gray-950 dark:text-gray-100">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-950">
            <div class="absolute top-4 end-4">
                <button type="button" onclick="window.toggleTheme()" class="rounded-lg p-2 text-gray-500 hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-800" title="Tema">
