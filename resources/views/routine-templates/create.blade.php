    ...
    <x-slot name="header">
        <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Ordena ejercicios y valores por defecto de reps y series</p>
            </div>
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-900 sm:p-8">
                <form action="{{ route('routine-templates.store') }}" method="POST" class="space-y-6" id="rt-form">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="mt-1 block w-full" type="text" name="name" :value="old('name')" placeholder="Ej. Lunes — Pecho / Tríceps" required />
