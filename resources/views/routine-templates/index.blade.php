                    ...
                    @forelse ($templates as $template)
                        <div class="flex flex-col gap-3 p-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                <a href="{{ route('workouts.create', ['plantilla' => $template->id]) }}" class="inline-flex items-center rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-xs font-semibold text-indigo-800 hover:bg-indigo-100 dark:border-indigo-800 dark:bg-indigo-950/40 dark:text-indigo-200">Usar plantilla</a>
